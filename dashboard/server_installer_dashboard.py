...
"""
    ...
    entrypoint_lines = [
        ...
        "",
        "# Configure agent to use local Ollama",
        f"echo 'Configuring agent to use Ollama model: {llm_model}'",
        f"export OLLAMA_HOST=http://127.0.0.1:11434",
        "",
        "# Write auth-profiles.json with Ollama credentials",
        "mkdir -p /root/.openclaw/agents/main/agent",
        f'echo \'{{"ollama":{{"provider":"ollama","baseUrl":"http://127.0.0.1:11434","apiKey":"ollama"}}}}\' > /root/.openclaw/agents/main/agent/auth-profiles.json',
