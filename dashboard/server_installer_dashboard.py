...
"""
    ...
    entrypoint_lines = [
        ...
        "echo 'Verifying OLLAMA_API_KEY is visible to Node.js...'",
        "node -e 'console.log(\"Node sees OLLAMA_API_KEY:\", process.env.OLLAMA_API_KEY || \"NOT SET\")'",
        f"env OLLAMA_API_KEY=ollama-local openclaw gateway --allow-unconfigured --bind loopback --port {gw_internal_port} --verbose &",
        "GW_PID=$!",
        "sleep 5",
        "",
