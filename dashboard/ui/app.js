...
function App() {
  ...
  const buildDotnetDockerManualHelper = React.useCallback(() => ({
    ...
    intro: "Deploy the .NET API behind Nginx reverse proxy with HTTPS support.",
    sections: [
      {
        title: "Folder Structure",
        body: "Use this tested directory structure.",
        code: [
          "C:\\WeighingSystem\\",
          " +-- docker-compose.yml",
          " +-- nginx.conf",
      ...
      {
        title: "Step 1: Go to WeighingSystem",
        body: "",
        code: [
          "cd C:\\WeighingSystem",
        ].join("\n"),
      ...
      {
        title: "Step 2: Create API/Dockerfile",
        body: "Create a file named `API/Dockerfile` with no extension.",
        code: [
      ...
      {
        title: "Step 5: Generate self-signed certificates",
        body: "",
        code: [
          "mkdir certs",
      ...
      {
        title: "Step 7: Verify",
        body: "You should see both `API` and `api-nginx` containers running.",
        code: [
          "docker ps",
        ].join("\n"),
        language: "powershell",
  ...
  const buildS3ManualHelper = React.useCallback(() => {
    return {
      ...
      intro: "Deploy MinIO object storage behind Nginx with HTTP + HTTPS.",
      sections: [
        {
        ...
        {
          title: "Step 0: Clean (if re-deploying)",
          body: "",
          code: [
        ...
        },
        {
          ...
          body: "Verify you have `certs/private.key` and `certs/public.crt` after this.",
          code: [
            "docker run --rm -v ${PWD}/certs:/certs alpine sh -c \"",
            "apk add --no-cache openssl &&",
        ...
        {
          title: "Step 3: Create nginx/nginx.conf",
          body: "",
          code: [
            "events {}",
            "",
        ...
        },
        {
          ...
          body: "",
          code: [
            "MinIO API listens on port 9000, UI (console) on port 9001.",
  ...
  const buildMongoDockerManualHelper = React.useCallback(() => ({
    ...
    intro: "Deploy MongoDB with Mongo Express UI behind Nginx with HTTP + HTTPS.",
    sections: [
      {
        title: "Directory Structure",
        body: "",
      ...
      },
      {
        ...
        {
          title: "Step 2: Generate SSL certificates",
          body: "",
          code: [
            "docker run --rm -v ${PWD}/certs:/certs alpine sh -c \"",
            "apk add --no-cache openssl &&",
      ...
      {
        title: "Connection String (for code)",
        body: "",
        code: [
