(() => {
  ...
  ns.pages["python-system"] = function renderPythonSystemPage(p) {
    ...
    const systemHost = selectableIps.includes(String(pythonApiEditor?.host || "").trim()) ? String(pythonApiEditor?.host || "").trim() : getDefaultSelectableIp(selectableIps);
    return (
        ...
        <Grid item xs={12} md={8}>
          <ActionCard
            ...
            fields={[
              ...
              { name: "PYTHON_API_PORT", label: "HTTPS Port", defaultValue: pythonApiEditor?.targetPage === "python-system" ? (pythonApiEditor?.port || "8443") : "8443", placeholder: "Leave empty to skip HTTPS", checkPort: true, certSelect: "SSL_CERT_NAME" },
