  ...
  ns.pages["ai-sam3-api"] = function renderSam3ApiPage(p) {
    ...
    const sections = [
      { name: "Image Detection", color: "#7c3aed", eps: [
        { m: "POST", p: "/detect", d: "Detect objects in an image using text prompts. Upload an image file and specify what objects to find.", body: 'multipart/form-data:\n  image: (file) JPEG/PNG image\n  text_prompt: (string) "person,car,dog"\n  confidence: (float) 0.0-1.0, default 0.25', res: '{\n  "original": "base64-image...",\n  "image_size": [1920, 1080],\n  "objects": [\n    {\n      "label": "person",\n      "confidence": 0.95,\n      "bbox": [100, 50, 300, 400],\n      "mask": "base64-png..."\n    }\n  ],\n  "stats": {\n    "objects_detected": 3,\n    "processing_time": "0.45s",\n    "avg_confidence": "92.3%"\n  }\n}' },
        { m: "POST", p: "/detect-point", d: "Segment the object at specific pixel coordinates. Use labels: 1 = foreground, 0 = background.", body: 'multipart/form-data:\n  image: (file) JPEG/PNG\n  points: (JSON string) "[[250, 300], [100, 100]]"\n  labels: (JSON string) "[1, 0]"\n  confidence: (float) default 0.25', res: '{\n  "original": "base64...",\n  "objects": [{ "mask": "base64...", "confidence": 0.98 }],\n  "stats": { "objects_detected": 1 }\n}' },
        { m: "POST", p: "/detect-box", d: "Segment objects within bounding boxes.", body: 'multipart/form-data:\n  image: (file) JPEG/PNG\n  bboxes: (JSON string) "[[x1,y1,x2,y2], ...]"\n  confidence: (float) default 0.25', res: '{\n  "original": "base64...",\n  "objects": [{ "mask": "base64...", "confidence": 0.97 }],\n  "stats": { "objects_detected": 1 }\n}' },
        { m: "POST", p: "/detect-exemplar", d: "Find similar objects using a visual reference. Provide the image and a reference bounding box of what to find.", body: 'multipart/form-data:\n  image: (file) full image\n  reference_bbox: (JSON string) "[x1, y1, x2, y2]"\n  confidence: (float) default 0.25', res: '{\n  "original": "base64...",\n  "objects": [{ "mask": "base64...", "confidence": 0.92 }],\n  "stats": { "objects_detected": 2 }\n}' },
        { m: "POST", p: "/detect-live", d: "Real-time detection for camera frames. Optimized for speed — returns lightweight results.", body: 'multipart/form-data:\n  image: (file) camera frame\n  text_prompt: (string) objects to detect\n  confidence: (float) default 0.25\n  grid_mode: (string) "off"|"on"\n  quality: (int) JPEG quality 1-100, default 50\n  track_x: (int) optional track point X\n  track_y: (int) optional track point Y', res: '{\n  "annotated": "base64-jpeg...",\n  "stats": {\n    "objects_detected": 2,\n    "processing_time": "0.04s"\n  }\n}' },
      ]},
